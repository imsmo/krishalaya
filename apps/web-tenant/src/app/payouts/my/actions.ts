'use server';
// apps/web-tenant/src/app/payouts/my/actions.ts (moved from /payouts by PC-56 TENANT-4b — see the page header) · the tenant's money-OUT mutations. The only place the authed
...
function back(qs: string): never { redirect(`/payouts/my?${qs}`); }
