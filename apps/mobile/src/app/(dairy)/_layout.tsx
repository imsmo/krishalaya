...
// Home / Diary / Bills / D2C / Rates (the D2C tab shipped in PC-55 B6 on W54-5). Auth-gated + behind the `dairy` kill-switch (Law 10). This persona is a TRUST
...
export default function DairyTabsLayout() {
  ...
  return (
    <Tabs screenOptions={{ headerShown: false, tabBarActiveTintColor: color.primary600 }}>
      ...
      <Tabs.Screen name="d2c" options={{ title: t('dairyapp.tab.d2c'), tabBarIcon: ({ focused }) => <Icon glyph="🏠" focused={focused} /> }} />
