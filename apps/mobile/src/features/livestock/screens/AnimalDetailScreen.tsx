...
// DEV-11 (2026-07-24, Group-B EmptyState pass set 1): canon ref `screens/199-farmer-animal-profile.html`
// ("199 · Animal Profile"). Behind `livestock` (DEV-08 census §2 Group-B genuine gap — zero `(livestock)` route
