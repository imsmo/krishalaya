// apps/mobile/src/features/vyapari-home/screens/SupplierShortlistScreen.tsx · screen · [P2]
// DEV-12 (2026-07-24, Group-B EmptyState pass set 2): canon ref `screens/67-buyer-search-results.html`
// ("67 · Search Results" — nearest concept — no literal supplier-shortlist screen exists; nearest existing buyer search/shortlist pattern). Behind `vyapari` (DEV-08 census §2 Group-B genuine gap — zero
