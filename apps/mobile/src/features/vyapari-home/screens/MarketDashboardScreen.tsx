// apps/mobile/src/features/vyapari-home/screens/MarketDashboardScreen.tsx · screen · [P2]
// DEV-12 (2026-07-24, Group-B EmptyState pass set 2): canon ref `screens/52-farmer-mandi-prices.html`
// ("52 · Today's Mandi Prices" — nearest concept — no literal trader-market-dashboard screen exists; nearest existing market-price pattern). Behind `vyapari` (DEV-08 census §2 Group-B genuine gap — zero
