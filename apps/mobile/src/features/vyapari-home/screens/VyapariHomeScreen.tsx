// apps/mobile/src/features/vyapari-home/screens/VyapariHomeScreen.tsx · screen · [P2]
// DEV-12 (2026-07-24, Group-B EmptyState pass set 2): canon ref `screens/13-buyer-home.html`
// ("13 · Buyer Home" — nearest concept — no literal vyapari/trader-home screen exists; nearest existing bulk-buyer home pattern). Behind `vyapari` (DEV-08 census §2 Group-B genuine gap — zero
