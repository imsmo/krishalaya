...
// DEV-12 (2026-07-24, Group-B EmptyState pass set 2): canon ref `screens/238-worker-mcc-daily-summary.html`
// ("238 · MCC Daily Summary" — nearest concept — the daily summary is the end-of-shift close concept; no dedicated shift-close screen exists). Behind `mcc_operator` (DEV-08 census §2 Group-B genuine gap — zero
