...
// DEV-12 (2026-07-24, Group-B EmptyState pass set 2): canon ref `screens/236-worker-mcc-operator-dashboard.html`
// ("236 · MCC Operator Dashboard" — nearest concept — the operator dashboard is where BMC/chiller status would surface; no dedicated BMC-status screen exists). Behind `mcc_operator` (DEV-08 census §2 Group-B genuine gap — zero
