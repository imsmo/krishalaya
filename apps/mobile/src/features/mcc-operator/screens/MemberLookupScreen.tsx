...
// DEV-12 (2026-07-24, Group-B EmptyState pass set 2): canon ref `screens/239-worker-mcc-farmer-ledger.html`
// ("239 · MCC Farmer Ledger" — nearest concept — the farmer/member ledger includes lookup; no dedicated lookup-only screen exists). Behind `mcc_operator` (DEV-08 census §2 Group-B genuine gap — zero
