// apps/mobile/src/features/fpo-coordinator/screens/GroupSettlementScreen.tsx · screen · [P2]
// DEV-12 (2026-07-24, Group-B EmptyState pass set 2): canon ref `screens/368-farmer-contract-settlement.html`
// ("368 · Contract Settlement" — nearest concept — no literal group-lot-settlement screen exists; nearest existing settlement pattern). Behind `fpo_coordinator` (DEV-08 census §2 Group-B genuine gap — zero
...
export default function GroupSettlementScreen() {
  ...
  return (
    <ScreenScaffold title={t('fpoCoordinatorGroupSettlement.title')}>
      <EmptyState
        ...
        testID="fpo-group-settlement-empty-state"
      />
    </ScreenScaffold>
  );
}
