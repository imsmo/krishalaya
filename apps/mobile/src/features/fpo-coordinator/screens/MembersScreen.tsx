// apps/mobile/src/features/fpo-coordinator/screens/MembersScreen.tsx · screen · [P2]
// DEV-12 (2026-07-24, Group-B EmptyState pass set 2): canon ref `screens/76-tenant-farmers.html`
// ("76 · Farmers" — nearest concept — no literal FPO-member-roster screen exists; nearest existing member/farmer-list pattern). Behind `fpo_coordinator` (DEV-08 census §2 Group-B genuine gap — zero
...
export default function MembersScreen() {
  ...
  return (
    <ScreenScaffold title={t('fpoCoordinatorMembers.title')}>
      <EmptyState
        ...
        testID="fpo-members-empty-state"
      />
    </ScreenScaffold>
  );
}
