...
// DEV-12 (2026-07-24, Group-B EmptyState pass set 2): canon ref `screens/459-vet-availability-calendar.html`
// ("459 · Vet Availability Calendar" — nearest concept — this is the vet's own bookings/availability calendar). Behind `vet` (DEV-08 census §2 Group-B genuine gap — zero
