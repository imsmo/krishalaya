...
// DEV-12 (2026-07-24, Group-B EmptyState pass set 2): canon ref `screens/468-warehouse-occupancy-dashboard.html`
// ("468 · Occupancy Dashboard" — nearest concept — no literal agri-input-store-inventory screen exists; nearest existing stock-tracking pattern). Behind `store_owner` (DEV-08 census §2 Group-B genuine gap — zero
