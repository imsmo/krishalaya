...
// DEV-12 (2026-07-24, Group-B EmptyState pass set 2): canon ref `screens/22-my-orders.html`
// ("22 · My Orders" — nearest concept — no literal store-owner-orders screen exists; nearest existing generic order-list pattern). Behind `store_owner` (DEV-08 census §2 Group-B genuine gap — zero
