...
// DEV-12 (2026-07-24, Group-B EmptyState pass set 2): canon ref `screens/465-warehouse-assay-record.html`
// ("465 · Assay Record" — nearest concept — no literal batch/expiry-tracking screen exists for a store role; nearest existing batch-level record pattern). Behind `store_owner` (DEV-08 census §2 Group-B genuine gap — zero
