'use client';
// apps/web-ops/src/components/LocaleSwitcher.tsx · the console language picker. A real <form> that POSTs to
// /api/lang (which validates + sets the kvo_lang cookie + redirects back) — so it works WITHOUT client JS; the
