...
const BUILT: ReadonlyArray<{ key: string; href: string }> = [{ key: 'kiosk', href: '/kiosk' }, { key: 'warehouse', href: '/warehouse' }]; // OW-1, OW-2
const WAVES = ['chc', 'dairypos', 'money', 'insights'] as const;
