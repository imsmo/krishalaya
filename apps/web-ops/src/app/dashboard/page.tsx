...
const BUILT: ReadonlyArray<{ key: string; href: string }> = [{ key: 'kiosk', href: '/kiosk' }, { key: 'warehouse', href: '/warehouse' }, { key: 'chc', href: '/equipment' }]; // OW-1..3
const WAVES = ['dairypos', 'money', 'insights'] as const;
