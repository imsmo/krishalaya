// apps/web-ops/src/lib/auth.ts · session cookies for the authenticated console. The access + refresh tokens
...
export const ACCESS_COOKIE = 'kvo_access';
export const REFRESH_COOKIE = 'kvo_refresh';
