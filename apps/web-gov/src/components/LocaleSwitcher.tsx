'use client';
// apps/web-gov/src/components/LocaleSwitcher.tsx · the console language picker. A real <form> that POSTs to
// /api/lang (which validates + sets the kvg_lang cookie + redirects back) — so it works WITHOUT client JS; the
