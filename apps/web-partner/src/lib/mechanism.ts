...
// separation: parsing lives in `@krishi-verse/ui`, only the Next.js `cookies()` read is app-specific). MINIMAL
// WIRING (per this batch's own scope note): web-partner is not yet on `@krishi-verse/ui`'s ported shell (its
