// apps/admin-api/src/modules/schemes-oversight/domain/pii-mask.ts · server-side masking for the cross-tenant
// applications list (W074). Pure, no I/O.
//
...
import { UnmaskReasonRequiredError } from './schemes-oversight.errors';
