...
// ../../../Phase-1 all screen design/Krishalaya_Design_System/designer_pack/tokens/design-tokens.json
...
// the whole krishalaya/ tree for `@krishalaya/tokens` imports outside this
...
const SOURCE_JSON = path.join(
  __dirname, '..', '..', '..',
  'Phase-1 all screen design', 'Krishalaya_Design_System',
...
// `internal/theme.ts` disclosed this exact gap ("GENUINE GAP: @krishalaya/tokens has NO dark-mode export at
...
function main() {
  ...
  const header = `// @krishalaya/tokens · GENERATED from designer_pack/tokens/design-tokens.json — DO NOT HAND-EDIT.
